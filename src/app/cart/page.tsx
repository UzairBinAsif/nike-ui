...
import heart from "@/../public/vectorheart.svg"
import trash from "@/../public/trashbox.svg"
    ...
    <div className="md:max-w-[1280px] mx-auto">
      <div className="px-3 mt-10 md:px-32 md:mt-10">
        <div className="md:flex">
            ...
            <div className="p-[10px] px-[10px] md:p-[10px] md:px-[10px] bg-[#F7F7F7]">
              ...
              <div className="flex justify-between md:flex md:gap-x-5">
                <p className="text-[16px] font-[400] md:text-[11px] md:font-[400]">
                  Applies to orders of ₹ 14 000.00 <span className="underline cursor-pointer font-bold">View details</span> or more.
                </p>
              </div>
            </div>
          ...
          <div className="md:w-[30%] md:pl-5 gap-x-10">
            <div>
              ...
              <Link href={"/checkout"}>
                <button className="mb-10 border-[#E5E5E5] mt-[40px] h-[40px] rounded-[20px] w-[100%] md:border-[#E5E5E5] md:mt-[40px] md:h-[40px] md:rounded-[20px] md:w-[100%] bg-black text-white">
                  Member Checkout
                </button>
              </Link>
            </div>
